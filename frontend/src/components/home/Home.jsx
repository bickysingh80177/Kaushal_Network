...
const Home = () => {
  return (
    <div>
      <Navbar />
      <div className="mb-8">
        <h1 className="xs:mt-4 xs:text-sm lg:text-4xl lg:mt-5 flex justify-center font-extralight">
          Join Kaushal Network
        </h1>
        <h3 className="xs:text-sm lg:text-xl lg:mt-5 flex justify-center font-extralight">
        ...
        <div className="flex justify-center items-center sm:flex-col mt-8">
          ...
          <button className="xs:mt-8 sm:mt-10 sm:px-2 sm:w-24 sm:h-8 sm:gap-2 sm:py-1 bg-[#253974] text-white rounded-md lg:px-4 lg:py-2 text-sm lg:p-auto hover:bg-[#3E63DD] hover:text-gray-400 lg:ms-8 flex items-center justify-center gap-4 h-10 w-32">
            <svg
        ...
        <div className="flex sm:flex-col sm:items-center sm:mt-4 lg:mt-8 lg:flex-row lg:w-3/4 lg:m-auto lg:gap-8">
          ...
          <div className="xs:mt-8 sm:w-3/4 sm:mt-12 lg:w-2/6">
        ...
        <div className="flex flex-col items-center sm:mt-4 lg:mt-8">
          <h3 className="xs:text-center xs:text-base sm:text-xl lg:text-2xl font-medium">
